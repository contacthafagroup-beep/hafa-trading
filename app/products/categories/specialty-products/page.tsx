...
export default function SpecialtyProductsPage() {
  ...
  const specialtyProducts = [
    { emoji: '🍯', name: 'Pure Honey', desc: 'White, Red, Forest - Raw and unprocessed', animation: 'pulse' },
    { emoji: '☕', name: 'Coffee Beans', desc: 'Arabica premium grade, single origin', animation: 'bounce' },
    { emoji: '🌿', name: 'Khat (Miraa)', desc: 'Fresh harvest, where legally permitted', animation: 'float' },
    { emoji: '🌵', name: 'Aloe Vera', desc: 'Fresh leaves, thick gel-rich', animation: 'pulse' },
    { emoji: '🌿', name: 'Moringa', desc: 'Leaves & powder, nutrient-dense superfood', animation: 'bounce' },
    { emoji: '🌻', name: 'Sesame Oil', desc: 'Cold-pressed, pure, unrefined', animation: 'spin' },
    { emoji: '🍍', name: 'Dried Fruits', desc: 'Mango, pineapple, banana - No added sugar', animation: 'float' },
    { emoji: '🌶️', name: 'Dehydrated Vegetables', desc: 'Garlic, ginger, onion - Long shelf life', animation: 'pulse' },
    { emoji: '💧', name: 'Essential Oils', desc: 'Rosemary, eucalyptus, basil - Therapeutic grade', animation: 'bounce' },
    { emoji: '🍵', name: 'Herbal Tea Mixes', desc: 'Traditional Ethiopian recipes', animation: 'float' }
  ];
      ...
      <section className="relative bg-gradient-to-br from-yellow-600 via-amber-700 to-orange-900 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-2xl mb-6">Unique • High-Value • Ethiopian Origin</p>
